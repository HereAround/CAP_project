...
InstallMethod( TruncationFunctorLeft,
      ...
      function( graded_ring, subsemigroup_generator_list )
        ...
        return TruncationFunctor( graded_ring, subsemigroup_generator_list, true );
...
InstallMethod( TruncationFunctorRight,
      ...
      function( graded_ring, subsemigroup_generator_list )
        ...
        return TruncationFunctor( graded_ring, subsemigroup_generator_list, false );
